...
// file handle type
//typedef FILE* File; 
//said to remove this in class


//gave to us in class
//created a struct to group variables for the files
//created a pointer: fp of FILE type for control file operations
//Dr.G also said it makes code easier on the eyes
...
//gave to us in class
//creates a pointer to the struct that allows us to pass it as a parameter
